...
//DOMContentLoaded loads the HTML document after the DOM is ready for manipulation so that the js can be executed as soon as the document is loaded without having to wait for stylesheets etc. 
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('header.html')
        ...
        .then(content => {
            ...
            if (headerElement) headerElement.innerHTML = content;
        })
